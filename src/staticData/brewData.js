export default brewObject = {
  Pourover: {
    stepOne: {
      ...
      stepText: 'Place and rinse the Kalita Wave filter in the dripper. This removes the paper flavor from the filter and warms everything up. Heat up your mug while you’re at it.',
      next: 'MEASURE & GRIND',
    },
    stepTwo: {
      step: '2',
    ...
    stepFour: {
      ...
      title: 'Second Pour',
      stepText: 'At :45, pour water up to 200g in a spiral motion by 1:00. The spiral motion helps give you an even extraction and keeps everything integrated.',
      next: 'Pulse & Wait',
    },
    stepFive: {
      step: '5',
    ...
    stepSix: {
      ...
      title: 'Serve & Enjoy',
      stepText: 'Your brew volume should reach approximately 300ml or about to the top of a 10oz mug at 2:45 to 3:00. Remove the Wave from the carafe or mug and set it in the sink for the rest of the water to drain through.',
      next: 'Enjoy!',
    },
  }
}